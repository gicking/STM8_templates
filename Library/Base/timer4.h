...
// with attachable user functions 
  ...
  #define attachInterruptMillis(fct)   TIM4UPDAttachInterrupt(fct)            ///< attach user function to 1ms ISR
  #define detachInterruptMillis()      TIM4UPDAttachInterrupt(TIM4_Default)   ///< detach user function from 1ms ISR
#endif
...
#elif defined(__SDCC)
  void TIM4UPD_ISR(void) __interrupt(__TIM4UPD_VECTOR__);
#endif
