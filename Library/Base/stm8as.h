...
---*/
  ...
  #define __EXTI0_VECTOR__              3    ///< irq3 - External interrupt 0 (PORTA)
  #define __EXTI1_VECTOR__              4    ///< irq4 - External interrupt 1 (PORTB)
  #define __EXTI2_VECTOR__              5    ///< irq5 - External interrupt 2 (PORTC)
  #define __EXTI3_VECTOR__              6    ///< irq6 - External interrupt 3 (PORTD)
  #define __EXTI4_VECTOR__              7    ///< irq7 - External interrupt 4 (PORTE)
  ...
  #define __UART1_TXE_VECTOR__         17    ///< irq17 - USART / UART1 send interrupt
  #define __UART1_RXF_VECTOR__         18    ///< irq18 - USART / UART1 receive interrupt
  #define __I2C_VECTOR__               19    ///< irq19 - I2C interrupt
  #define __UART2_3_4_TXE_VECTOR__     20    ///< irq20 - LINUART / UART2,3,4 send interrupt
  #define __UART2_3_4_RXF_VECTOR__     21    ///< irq21 - LINUART / UART2,3,4 receive interrupt
