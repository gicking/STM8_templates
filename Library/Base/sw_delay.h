...
INLINE void sw_delay(uint32_t ms) {
  ...
  #if defined(__CSMC__)       // Cosmic v4.3.5
    #if defined(DEBUG)
      #define LOOP_MAX 1230   // debug: 0.004 + n * 1.0ms
    #else
      #define LOOP_MAX 4000   // speed optimized: 0.004 + n * 1.0ms
    #endif
  #elif defined(__SDCC)       // SDCC v3.6.2
    #if defined(DEBUG)
      #define LOOP_MAX 1070   // debug: 0.004 + n * 1.0ms
    #else
      #define LOOP_MAX 1070   // speed optimized: 0.004 + n * 1.0ms
    #endif
  #endif
